...
public class CliendEventBus {

    private static final ResourceLocation SUN_TEXTURES = new ResourceLocation("textures/environment/sun.png");
    private static final ResourceLocation MOON_PHASES_TEXTURES = new ResourceLocation(
            "textures/environment/moon_phases.png");
    private static final ResourceLocation AURORA_TEXTURE = new ResourceLocation(TestMod.MOD_ID,
            "textures/environment/aurora.png");
            ...
            public ISkyRenderHandler getSkyRenderHandler() {
                return new ISkyRenderHandler() {
                    ...
                    public void render(int ticks, float partialTicks, MatrixStack matrixStack, ClientWorld world, Minecraft mc)
                    {
                        ...
                        mc.getTextureManager().bindTexture(AURORA_TEXTURE);
                        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
                        float d = (float)(perlinNoiseGenerator.noiseAt(ticks/1000.0f, 0, false)*4);
                        float e = (float)(perlinNoiseGenerator.noiseAt(ticks/1000.0f, 500, false)*4);
                        float h = (float)(perlinNoiseGenerator.noiseAt(ticks/1000.0f, 1000, false)*4);
                        float g = (float)(perlinNoiseGenerator.noiseAt(ticks/1000.0f, 1500, false)*4);
                        bufferbuilder.pos(matrix4f1, -10+d, 1.0f, -10+d-f).tex(0.0F, 0.0F).endVertex();
                        bufferbuilder.pos(matrix4f1, 10+e, 1.0f, -10+e-g).tex(1.0F, 0.0F).endVertex();
                        bufferbuilder.pos(matrix4f1, 10+f, 1.0f, 10+f-d).tex(1.0F, 1.0F).endVertex();
                        bufferbuilder.pos(matrix4f1, -10+g, 1.0f, 10+g-e).tex(0.0F, 1.0F).endVertex();
